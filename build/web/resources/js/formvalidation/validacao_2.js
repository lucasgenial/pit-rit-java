...
$(document).ready(function () {
    //Config dos campos com o Select2
//    $("#semestre").select2({
//        ajax: {
...
//    });
                ...
                validators: {
                    callback: {
                        ...
                        callback: function(value, validator, $field) {
                            ...
                            var options  = validator.getFieldElements('semestre').val();
    ...
    .find('[name="semestre"]').select2({
        // Specify tags
        tags: ['1 Semestre', '2 Semestre', '3 Semetre', '4 Semestre']
    }).change(function(e) {
        $('#formCadastroPIT').formValidation('revalidateField', 'semestre');
    }).end();
});